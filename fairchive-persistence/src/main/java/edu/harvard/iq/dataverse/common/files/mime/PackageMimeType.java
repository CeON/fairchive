...
public enum PackageMimeType implements MimeType {
	/**
	 * Per https://en.wikipedia.org/wiki/Media_type#Vendor_tree just "dataverse"
	 * should be fine.
	 *
	 * @todo Consider registering this at http://www.iana.org/form/media-types or
	 *       switch to "prs" which "includes media types created experimentally or
	...
	PackageMimeType(final String mimeType) {
