...
public class DatasetEmbargoDialogTest {
	...
	void maximumEmbargoLength_notSet() {
		...
		this.dialog.validateEmbargoDate(null, null, todayPlusDays(400));
		
		verify(this.ui, times(0)).throwValidationException(anyString());
		
		this.dialog.validateEmbargoDate(null, null, DateUtil.today());
		
		verify(this.ui, times(1)).throwValidationException(anyString());
	}
	...
	void maximumEmbargoLength_set() {
		...
		verify(this.ui, times(2)).throwValidationException(anyString());
	}
	...
	void setAnfLiftEmbargo_isSuccessful() {
		...
		this.dialog.setCurrentEmbargoDate(todayPlusDays(2));
