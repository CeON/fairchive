...
class GeoShapeTest {
    ...
    public void calculateCenter__no_points() {
        ...
        //when & then
        assertThrows(IllegalArgumentException.class, () -> GeoShape.of(coordinates));
    }
    ...
    public void calculateCenter_one_point() {
        ...
        GeoShape result =  GeoShape.of(coordinates);

        // then
        assertThat(result.getCenter()).isEqualTo(new GeoPoint(1, 2));
    }
    ...
    public void calculateCenter_two_points() {
        ...
        // then
        assertThat(result.getCenter()).isEqualTo(new GeoPoint(3, 5));
    }
    ...
    public void calculateCenter_multiple_points() {
        ...
        // then
        assertThat(result.getCenter()).isEqualTo(new GeoPoint(35.840585,36.19439));
    }
