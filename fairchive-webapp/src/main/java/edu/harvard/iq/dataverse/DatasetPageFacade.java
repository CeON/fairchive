...
public class DatasetPageFacade {
    ...
    @Inject
    public DatasetPageFacade(DatasetVersionRepository dsvRepository, 
                             LicenseDifferenceFinder licenseDifferenceFinder,
    ...
    public Dataset findByGlobalId(String globalId) {
        return datasetService.findByGlobalId(globalId);
    }
    ...
    public void assignDatasetThumbnailByNativeQuery(Dataset dataset, DataFile datafile) {
        datasetService.assignDatasetThumbnailByNativeQuery(dataset, datafile);
    }
